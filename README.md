...
To apply deep learning (CNN) for feature extraction and classification

To provide an easy-to-use web interface for users
...
Type: Custom medicinal plant leaf image dataset
...
Images are RGB leaf images

Dataset is divided into training and testing sets

100 images were used for testing
